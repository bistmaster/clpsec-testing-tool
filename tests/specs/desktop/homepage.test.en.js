...
module.exports = {
  ...
  'Check on the Carousel': (browser) => {
    ...
    if(browser.options.desiredCapabilities.browser == 'IE')
      browser.assert.cssProperty("div.carousel-inner div.carousel-item:first-child", "background-image", `url("${browser.globals.protocol}://images.ctfassets.net/v7rhwo5gj231/21MlXWCGoI1K8OxOsMZOXr/8732fe168c48fbd1754cf5c168e09bf3/Heroimage_Cropped_2.jpg?w=1920&h=510&q=90&fm=jpg&fit=fill")`.toLocaleLowerCase());
    else
      browser.assert.cssProperty("div.carousel-inner div.carousel-item:first-child", "background-image", `url("${browser.globals.protocol}://images.ctfassets.net/v7rhwo5gj231/21MlXWCGoI1K8OxOsMZOXr/8732fe168c48fbd1754cf5c168e09bf3/Heroimage_Cropped_2.jpg?w=1920&h=510&q=90&fm=jpg&fit=fill")`);
  ...
  'Check on the Sections':  (browser) => {
    ...
    browser.assert.containsText('div > .sec-1-content > h2', homepage.section1.title.trim());
    ...
    browser.assert.containsText('div > .sec-2-content > h2', homepage.section2.title.trim());
